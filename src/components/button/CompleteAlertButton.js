...
function CompleteAlertButton({isOpen, leastDestructiveRef,onClose,currentCompletePage,release,currentShipPage}) {
    ...
    const onClickHandler = () => {
        dispatch(callCompleteAPI({
            onSuccess: () => {
                const title = '주문 완료 처리 완료';
                const desc = '주문 완료 처리가 완료 되었습니다.';
...
export default CompleteAlertButton;